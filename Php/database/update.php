...
if($_GET['id']){
    // echo "id found";
   $id=$_GET['id'];
    $getdata="SELECT * FROM `student` WHERE stdid='$id';";
...
<input type="email" name="email" id="" class="form-control my-2" placeholder="Enter student email no" value="<?php echo $email ?>">
