...
SELECT METHOD, SUM(AMOUNT) as Total_AMOUNT, COUNT(ID) as COUNT, CITY FROM Payments
GROUP BY METHOD Having CITY="Karachi" AND NOT METHOD = "COD";

-- SUB QUERIES
SELECT AVG(AMOUNT) FROM Payments;

SELECT *, (SELECT AVG(AMOUNT) FROM Payments) as AVG_AMOUNT FROM Payments
